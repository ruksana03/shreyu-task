...
import Departments from "../pages/Task/Employees/Departments/Departments";
import Designations from "../pages/Task/Employees/Designations/Designations";
...
const employeeDepartmentsRoutes: RoutesProps = {
...
const employeeDesignationsRoutes: RoutesProps = {
...
const employeeTimesheetsRoutes: RoutesProps = {
...
const employeeShiftAndScheduleRoutes: RoutesProps = {
